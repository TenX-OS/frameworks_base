...
public class BatteryBar extends RelativeLayout implements Animatable {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observer() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.BATTERY_BAR_ENABLED), false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
    ...
    private void updateSettings() {
        ...
        mChargingColor = Settings.System.getIntForUser(resolver,
                Settings.System.BATTERY_BAR_CHARGING_COLOR, 0xFF00FF00, UserHandle.USER_CURRENT);
        mBatteryLowColorWarning = Settings.System.getIntForUser(resolver,
        ...
        mHighColor = Settings.System.getIntForUser(resolver,
                Settings.System.BATTERY_BAR_HIGH_COLOR, 0xFF99CC00, UserHandle.USER_CURRENT);
